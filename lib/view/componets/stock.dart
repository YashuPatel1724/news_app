...
FutureBuilder<NewsModal?> buildStock(BuildContext context) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) => InkWell(
                  onTap: () {
                   ...
                   // String url =  newsController.newsModal!.articles[newsController.selectIndex].url;
                    newsController.urlLaunch(newsController.newsModal!.articles[newsController.selectIndex].url);
                   // if(url != null && url.isNotEmpty)
                   //   {
                   //     newsController.urlLaunch(url);
                   //   }
                   // else
                   //   {
                   //     Center(
